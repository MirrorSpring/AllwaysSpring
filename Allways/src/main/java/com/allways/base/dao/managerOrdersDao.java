...
public interface managerOrdersDao {
	...
	public void ManagerAddStatus(int ordersId, String o_customerId, int o_cakeId, int o_goodsId, int ordersSalePrice, int ordersQuantity, int ordersPoint) throws Exception;
	public void ManagerAlterStatus(int ordersId) throws Exception;
	public void ManagerAddStatus2(int ordersId, String o_customerId, int o_cakeId, int o_goodsId, int ordersSalePrice, int ordersQuantity, int ordersPoint) throws Exception;
